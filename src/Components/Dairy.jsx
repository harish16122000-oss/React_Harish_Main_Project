...
const Dairy = ({Mybutton, datam}) => {
   const wheat = datam?.Dairy || [];
...
try{
     ...
     const res = await axios.get("http://localhost:5000/Dairy");
      setWheat(res.data);
   }
     catch(error){
  ...
  return (
    ...
    <div>
       ...
       <Typography variant='h2'sx={{textAlign:'center', marginTop:'50px', color:'#2E7D32', fontWeight:600, marginBottom:{xs:"0px",md:'40px'}}}>Dairy Products</Typography>
